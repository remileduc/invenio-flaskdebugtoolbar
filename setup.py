...
g = {}
with open(os.path.join('invenio_flaskdebugtoolbar', 'version.py'), 'rt') as fp:
    exec(fp.read(), g)
    version = g['__version__']

setup(
    name='invenio-flaskdebugtoolbar',
    version=version,
    description=__doc__,
    ...
    url='https://github.com/inveniosoftware/invenio-flaskdebugtoolbar',
    packages=packages,
    zip_safe=False,
