...
project = u'Invenio-FlaskDebugToolbar'
...
with open(os.path.join(os.path.dirname(__file__), '..',
                       'invenio_flaskdebugtoolbar', 'version.py'),
          'rt') as fp:
    exec(fp.read(), g)
...
html_theme_options = {
    ...
    'extra_nav_links': {
        'invenio-flaskdebugtoolbar@GitHub': 'https://github.com/inveniosoftware/invenio-flaskdebugtoolbar',
        'invenio-flaskdebugtoolbar@PyPI': 'https://pypi.python.org/pypi/invenio-flaskdebugtoolbar/',
    }
}
...
htmlhelp_basename = 'invenio-flaskdebugtoolbar_namedoc'
...
latex_documents = [
  (master_doc, 'invenio-flaskdebugtoolbar.tex', u'invenio-flaskdebugtoolbar Documentation',
   u'CERN', 'manual'),
]
